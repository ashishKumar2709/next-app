...
const IdeaCard: React.FC<IdeaCardProps> = ({
  ...
  const handleProfileView = () => {
    if (  postDetails.creator._id === session?.user.id) return router.push("/profile");
    router.push(
  ...
  return (
    <div className="flex flex-col gap-4 p-4 border-0 border-solid border-gray-700 shadow-2xl rounded-md w-3/4 rounded bg-blue-50">
      <div className="flex justify-between">
        <div className="flex gap-4 cursor-pointer" onClick={handleProfileView}>
          <Image
